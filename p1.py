...
# # hal main to aaj che ho mara vala aana sivay kai nathi ho ne 
# # # FastAPI and server
# # fastapi==0.115.12
# # uvicorn==0.34.0
# # starlette==0.46.1
...
# # # LangChain for HuggingFace integration
# # langchain-huggingface==0.1.0
# # langchain-core==0.3.0

# # # HuggingFace Hub (required by langchain-huggingface)
...
# # # WebSocket support (for FastAPI WebSocket)
# # websockets==15.0.1
